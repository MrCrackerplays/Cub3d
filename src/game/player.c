...
/*   Updated: 2022/03/22 16:13:50 by rdrazsky      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->player_pos.x = data->player_pos.x + MOVE_SPEED * cosf(angle);
	data->player_pos.y = data->player_pos.y + MOVE_SPEED * sinf(angle);
}
